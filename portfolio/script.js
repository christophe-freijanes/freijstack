...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        fr: {
            ...
            'project.docker.link': 'Docker Hub',
            'project.iac.title': 'Infrastructure as Code',
            'project.iac.desc': 'Templates Terraform et CloudFormation pour provisionner et gérer l\'infrastructure cloud de manière déclarative et versionnable.',
            'project.iac.link': 'Bientôt disponible',
            // Expérience
        ...
        en: {
            ...
            'project.docker.link': 'Docker Hub',
            'project.iac.title': 'Infrastructure as Code',
            'project.iac.desc': 'Terraform and CloudFormation templates to provision and manage cloud infrastructure declaratively and versioned.',
            'project.iac.link': 'Coming soon',
            // Experience
